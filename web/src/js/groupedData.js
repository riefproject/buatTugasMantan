...
function updateTable() {
    ...
    for(let i =0 ;i<lowerBounds.length;i++){
        ogivex.push(lowerBounds[i]);
    }
    ogivex.push(upperBounds[upperBounds.length -1]+1);
    ...
    let freqHelpersReversed = [...freqHelpers].reverse()
    return {
        ...
        decilValues: decilValues,
        percentilValues: percentilValues,
        ogivex: ogivex,
        freqHelpers: freqHelpers,
        freqHelpersReversed: freqHelpersReversed,
